...
print(re.findall(r'[bh][aiu]t',data))
...
ret = re.match("[\w_]{4,20}@163\.com",data)
print(ret.group())
...
print(re.findall(r'[12]\d{3}\-[01]\d\-[0123]\d\s*[012]\d\:[012345]\d\:[012345]\d', data))
...
print(re.findall(r'([A-Za-z]+) ([A-Za-z]+)',data))
